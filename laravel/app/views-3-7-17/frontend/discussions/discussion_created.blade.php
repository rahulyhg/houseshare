			...
			<div class="col-md-9">
				...
				<div class="tab-content">
					<div id="menu1" class="tab-pane fade in active">
						...
						<div class="row over">
							<div class="col-md-12">
								{{ Form::open(array('url' => array('/discussion-created/'.Route::input('group_id')), 'name'=>'SearchGroup', 'id'=>'discussionForm', 'files'=>true)) }} 
									<div class="create-diss1 white m-t-30">
										<div class="">
											...
											<div class="form-group">					
												...
												{{ Form::text('topic_name',null, array('placeholder'=> 'New Topic', 'class'=>'form-control jui'))}}
												<span class="help-block"> {{$errors->first('topic_name')}} </span>
											</div>
											
											<div class="form-group">					
												<label for="topic_name" class="lab-bh">Subject<span class="red">*</span></label>
											...
											<div class="form-group">					
												<label for="name" class="lab-bh">About Topic<span class="red">*</span></label>
												{{ Form::textarea('topic_description',null, array('rows'=>3, 'placeholder'=> 'About Topic', 'class'=>'ckeditor form-control'))}} 
												<span class="help-block"> {{$errors->first('topic_description')}} </span>
											</div> 		  
												...
												<div class="col-md-6 form-group"> 
													...
													<div class="input-group col-xs-12"> 
														...
														<span class="input-group-btn">
															<button class="browse btn gry" type="button">  Choose</button>
														</span>
													</div>
												</div>
												<div class="col-md-12">
													<div class="text-center"> 
														<a href="javascript:;" onclick="document.getElementById('discussionForm').submit();"  class="rrri"> Post </a> 
													</div>
												</div> 
											</div> 
										</div>
