				...
				<div class="navigation">
					<nav class="main-nav">
						<ul class="list-unstyled">
							...
							<li><a href="{{URL::to('/place-an-ad')}}">PLACE AN AD</a></li>
							<li><a href="{{URL::to('/listing')}}">BROWSE PROPERTIES</a></li>
							<li><a href="{{URL::to('/listing/room-wanted')}}">BUDDY UPS</a></li>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<div class="checkbox checkbox-inline">
												{{ Form::checkbox('looking_house_share', 1, '', array('id'=>'checkbox30','data-bv-notempty'=>'false', 'data-bv-notempty-message'=>'false'))}}
												<label for="checkbox30">
													I am looking for an apartment or house share 
												</label>
											</div>
											<div class="checkbox checkbox-inline">
												{{ Form::checkbox('an_house_share', 1, '', array('id'=>'checkbox31','data-bv-notempty'=>'false', 'data-bv-notempty-message'=>'false'))}}
