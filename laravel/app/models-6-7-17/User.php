...
class User extends Eloquent implements UserInterface, RemindableInterface {
	...
	protected $fillable = array('role_id', 'email', 'password', 'first_name', 'last_name', 'dob', 'description', 'mobile', 'photo', 'gender', 'street_1', 'street_2', 'state', 'city', 'zip', 'country_id', 'status', 'is_fb', 'looking_house_share', 'an_house_share', 'varify_hash');
	...
	public function save_data($data = array(), $id = null){
		...
		$fields = array('role_id', 'email', 'password', 'first_name', 'last_name', 'office_name', 'office_website', 'description', 'mobile', 'photo', 'gender', 'street_1', 'street_2', 'state', 'city', 'zip', 'country_id', 'status', 'is_fb', 'looking_house_share', 'an_house_share');
