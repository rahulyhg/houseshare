         ...
         <div class="help-tabs-wrapper flex no-wrap">
            ...
            <div class="right-side-content">
               <div class="tab-content help-tabs">
                           ...
                           <div class="panel-group faqs-group" id="accordion" role="tablist" aria-multiselectable="true">
                              <div class="panel panel-default">
                                 <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title">
                                       <a class="collapsed flex space-between" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                              ...
                              <div class="panel panel-default">
                                 <div class="panel-heading" role="tab" id="headingTwo">
                                    <h4 class="panel-title">
                                       <a class="collapsed flex space-between" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                              ...
                              <div class="panel panel-default">
                                 <div class="panel-heading" role="tab" id="headingThree">
                                    <h4 class="panel-title">
                                       <a class="collapsed flex space-between" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                           ...
                           <div class="panel-group faqs-group" id="accordion3" role="tablist" aria-multiselectable="true">
                              <div class="panel panel-default">
                                 <div class="panel-heading" role="tab" id="headingseven">
                                    <h4 class="panel-title">
                                       <a class="collapsed flex space-between" role="button" data-toggle="collapse" data-parent="#accordion3" href="#collapseseven" aria-expanded="false" aria-controls="collapseseven">
                                       Do you have any free pricing plan?<span class="icon"><i class="ion-ios-plus-empty"></i></span>
                                       </a>
                                    </h4>
                                 </div>
                              ...
                              <div class="panel panel-default">
                                 <div class="panel-heading" role="tab" id="headingeight">
                                    <h4 class="panel-title">
                                       <a class="collapsed flex space-between" role="button" data-toggle="collapse" data-parent="#accordion3" href="#collapseeight" aria-expanded="true" aria-controls="collapseeight">
                              ...
                              <div class="panel panel-default">
                                 <div class="panel-heading" role="tab" id="headingnine">
                                    <h4 class="panel-title">
                                       <a class="collapsed flex space-between" role="button" data-toggle="collapse" data-parent="#accordion3" href="#collapsenine" aria-expanded="false" aria-controls="collapsenine">
                  ...
                  <!-- end #terms-of-service-tab-content -->
                  <div id="policies" class="tab-pane fade in">
                     <h1 class="tab-pane-title">Content Heading</h1>
                     <p>Content goes here</p>
                  </div>
                  <!-- end #policies-tab-content -->
